...
class SignUpViewController: UIViewController, UITextFieldDelegate, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    let userTypes = ["Student","Technician"]
    ...
    @IBAction func createUserAccount(_ sender: UIButton) {
        ...
        if (self.userPasswordField.text! != self.userConfirmPasswordField.text! || self.userEmailField.text! == "" || self.userFirstNameField.text! == "" || self.userLastNameField.text! == "" || self.userTypeField.text! == "" ){
            ...
            Auth.auth().createUser(withEmail: userEmailField.text!, password: userPasswordField.text!, completion: {
                ...
                if error != nil {
                    ...
                    var dictionary : [String : Any] = ["First Name" : self.userFirstNameField.text!,
